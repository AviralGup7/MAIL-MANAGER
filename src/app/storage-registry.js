...
const DOMAIN_KEYS = [
  { key: 'categoryRules', owner: 'src/app/rules.js', purpose: 'mutes, auto-archive, sender corrections, thread mutes', backup: true, reason: '' },
  { key: 'automationRules', owner: 'src/app/rule-engine.js', purpose: 'user automation rules', backup: true, reason: '' },
  { key: 'savedViews', owner: 'src/app/views.js', purpose: 'saved searches', backup: true, reason: '' },
  { key: 'templates', owner: 'src/app/templates.js', purpose: 'reply/forward templates', backup: true, reason: '' },
  { key: 'followups', owner: 'src/app/followups.js', purpose: 'awaited-reply tracking', backup: true, reason: '' },
  { key: 'deadlineOverrides', owner: 'src/app/deadline-store.js', purpose: 'user deadline corrections/dismissals', backup: true, reason: '' },
  { key: 'myCourses', owner: 'src/app/my-courses.js', purpose: 'course enrolment', backup: true, reason: '' },
  { key: 'snoozed', owner: 'src/app/snooze.js', purpose: 'snooze schedule', backup: true, reason: '' },
  { key: 'imageAllow', owner: 'src/app/reader.js', purpose: 'remote-image sender allow-list', backup: true, reason: '' },
  { key: 'timetable', owner: 'src/app/timetable-store.js', purpose: 'user-built timetable', backup: true, reason: '' },
  { key: 'composeDraft', owner: 'src/app/draft-store.js', purpose: 'compose crash-recovery draft', backup: false, reason: 'transient by design; a stale draft restored on another machine is a surprise, not a recovery' },
  { key: 'queryHistory', owner: 'src/app/suggest.js', purpose: 'recent search suggestions', backup: false, reason: 'reconstructible convenience, not investment' },
  { key: 'msgCache', owner: 'src/app/cache.js', purpose: 'warm-start message cache', backup: false, reason: 'reconstructed by sync' },
